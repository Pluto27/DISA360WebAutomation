...
namespace DISA360Automation.Features
{
...
#line hidden
        ...
        public virtual void AddItemsToTheToDoApp_Chrome()
        {
...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 6
 testRunner.Given("Navigate to App", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line hidden
#line 7
...
#line hidden
#line 11
 testRunner.Then("I verify whether the item is addded to the list", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
